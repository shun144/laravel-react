...
const UpdateCityHeavenApiForm = ({
    ...
    return (
        <section className={className}>
            <header>
                <h2
                    className={`text-lg font-medium text-gray-900 inline-block
                ...
                <p className="mt-1 mb-2 text-sm text-gray-600">
                    ...
                    シティヘブンが用意しているAPIを利用しております。シティヘブン側の仕様により当該APIの通信は暗号化されておりません。
                    <br />
                    そのため悪意がある第三者にアクセスキー及びショップIDが盗聴される可能性がございます。
                    <br />
                    本機能をご使用いただく場合、上記の件をご承知おきいただき、オーナ様ご本人の判断でアクセスキー及びショップIDをご登録ください。
                    <br />
                    なお、シティヘブンAPIを利用するタイミングは、以下2点になります。
                    <br />
                    <ul className="pl-8 list-disc">
                        ...
                        <li>
                            アンケート結果連絡時：アンケートの回答内容をもとに女の子一覧を作成するためにAPIを利用します。
                        </li>
                    </ul>
                </p>
            </header>
            ...
            <div className="w-full pt-4">
                {masking_access_key && masking_shop_id && (
                    <div className="w-full h-full flex flex-col justify-center items-start">
                        <div
                            className="text-[14px] text-white select-none bg-emerald-500/90 py-2 px-4 rounded grid grid-rows-2 grid-cols-2 gap-y-1 w-52"
