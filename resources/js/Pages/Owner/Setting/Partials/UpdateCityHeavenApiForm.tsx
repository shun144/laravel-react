        ...
        <section className={className}>
            <header>
                ...
                <p className="mt-1 mb-2 text-sm text-gray-600">
                    ...
                    シティヘブンが用意しているAPIを利用しております。シティヘブン側の仕様により当該APIの通信は暗号化されておりません。<br />
                    そのため悪意がある第三者にアクセスキー及びショップIDが盗聴される可能性がございます。<br />
                    本機能をご使用いただく場合、上記の件をご承知おきいただき、オーナ様ご本人の判断でアクセスキー及びショップIDをご登録ください。<br />
                    なお、シティヘブンAPIを利用するタイミングは、以下2点になります。<br />
                    <ul className='pl-8 list-disc'>
                        <li>本画面のアクセスキー及びショップIDの登録時：ご入力いただいたアクセスキー及びショップID整合性を確認するため利用します。</li>
                        <li>アンケート結果連絡時：アンケートの回答内容をもとに女の子一覧を作成するためにAPIを利用します。</li>
                    </ul>
                </p>
            </header>
