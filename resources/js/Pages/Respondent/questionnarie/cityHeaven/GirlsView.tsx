    ...
    <>
      ...
      <div className='w-full px-1 md:w-11/12'>
        <div className='grid mb-4 grid-cols-2 gap-x-3 gap-y-4
          ...
          {
            currentItems &&
            currentItems.map(({ id, name, catchphrase, w_shukkin, diary_flg, review_flg, earn_point, today_work_flg, picture_url, mypage_url, bwh, age, height, cup, isAllContain }, idx) => (
              ...
              <div key={id}>
                ...
                <div
                  ...
                  pt-0 px-1 h-[290px] min-h-[200px] max-h-[480px]
                  md:max-w-xl md:pt-4 md:px-2 md:h-[420px] md:min-h-[400px] md:max-h-[480px]"
                >
                  ...
                  <div className="w-full flex flex-col justify-between leading-normal">
                    ...
                    {/* 名前と年齢 */}
                    <div className="font-bold tracking-tight text-gray-900 text-md md:text-xl break-all overflow-hidden min-h-14 max-h-14">
                      {`${name}(${age})`}
                    </div>

                    {/* キャッチフレーズと3サイズ */}
                    <div className="font-normal text-gray-700 min-h-8 md:min-h-14 md:max-h-14 ">
                    ...
                    <div className="w-full flex flex-row justify-end items-end md:items-center h-8 min-h-5  md:min-h-7 md:mb-2">
                      <button
